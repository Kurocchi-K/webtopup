...
<template #payment_status="{ row }">
    <div class="flex flex-col gap-2">
        ...
        <span
            ...
            :class="{
                'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400': row.payment_status === 0,
                'bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400': row.payment_status === 1,
                'bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400': row.payment_status === 2,
                'bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400': row.payment_status === 3,
            }"
        >
            {{ 
                row.payment_status === 0 ? 'Pending' : 
                row.payment_status === 1 ? 'On Progress' : 
                row.payment_status === 2 ? 'Success' : 'Failed' 
            }}
        </span>
    </div>
</template>
